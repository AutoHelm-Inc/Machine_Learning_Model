# this code was inspired by the work done by Chris Hay
# the sample code it was inspired from can be found here: https://github.com/chrishayuk/opl-train/blob/main/JSONL/test.py

import jsonlines

# jsonl input and output paths
jsonl_input_paths = ["llama_prompts.jsonl"]
